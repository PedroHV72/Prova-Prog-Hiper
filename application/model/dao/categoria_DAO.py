...
class CategoriaDAO:
    def __init__(self):
        ...
        video3 = Video(3, "Triple Kill 1 ", "- RETAKE PARA RETOMAR ÁREA PERTO DO BOMB", "/videos/triple2.mp4", "/img/img-triple-2.jpg")
        video4 = Video(4, "Triple Kill 2 ", "- RETAKE PELA COSTAS IMPEDINDO O PLANT.", "/videos/triple1.mp4", "/img/img-triple-1.jpg")
